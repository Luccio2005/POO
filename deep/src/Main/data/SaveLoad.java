...
public class SaveLoad {
    ...
    public Entity getObject(String itemName){
        Entity obj = null;
        switch (itemName){
            case "Hacha de madera": obj = new OBJ_Axe(gp); break;
            case "Botas": obj = new OBJ_Boots(gp); break;
            case "Llave": obj = new OBJ_Key(gp); break;
            case "Lampara": obj = new OBJ_Lantern(gp); break;
            case "Pocion de vida": obj = new OBJ_Potion_Red(gp); break;
            ...
            case "Carpa": obj = new OBJ_Tent(gp); break;
