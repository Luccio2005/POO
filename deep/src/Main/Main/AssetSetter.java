...
public class AssetSetter {
    ...
    public void setInteractiveTile(){
        ...
        mapNum = 1;
        i = 0;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,5,19);
        i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,7,19);
        i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,5,23);
        i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,7,23);
        i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,5,27);
        i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,7,27);
        i++;
        mapNum = 2;
        i = 0;
        gp.iTile[mapNum][i] = new IT_MetalPlate(gp,78, 6);
        i++;
        gp.iTile[mapNum][i] = new IT_MetalPlate(gp,80, 55);
        i++;
        gp.iTile[mapNum][i] = new IT_MetalPlate(gp,20, 45);
        i++;
    }
}
