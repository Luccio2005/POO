...
public class Activos {
    ...
    public void setenemigos(){
        ...
        i=0;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*5;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*28;
        i++;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*9;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*28;
        i++;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*24;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*10;
        i++;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*21;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*20;
        i++;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*31;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*22;
        i++;
        gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*44;
        gp.enemigos[mapNum][i].mundoy = gp.tileSize*22;
        i++;
        /*gp.enemigos[mapNum][i] = new orco(gp);
        gp.enemigos[mapNum][i].mundox = gp.tileSize*12;
